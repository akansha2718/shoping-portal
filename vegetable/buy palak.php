...
<div class="dropdown">
 ...
 <input type="text" name="prd_name"/>
  ...
  if(isset($_POST['Quantity']))
  {
	...
	$sql="insert into quantity_detail values('','$prd_name',$price','$total','$shipping','$grand_total')";
	$result=mysql_query($sql)or die("database not work properly");
	echo "</br>";
	?>
	
	<script>
	alert("Entry fill successfully");
	</script>
	<?php
  }
...
<br><br>
  ...
  <form method="POST" action="">
<button class="btn btn-primary" name="final submit">final submit
	<script>
